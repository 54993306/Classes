...
namespace BattleSpace{
	...
	BaseRoleData::BaseRoleData()
		...
		,mCritTime(0),mMoveSpeed(0),mAlertRange(0),mCallType(sCallType::eCommon),mBehavior(sBehavior::eNormal),mRoleNature(sRoleType::eNULL)
	...
	float BaseRoleData::judgeAttribute( sProperty pType )			//队长技和其他很多地方使用，时间不够所有没有改为强枚举类型
	{
