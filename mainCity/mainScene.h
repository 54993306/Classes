...
class CMainScene:public CScene,public CCTargetedTouchDelegate
{
public:
	CMainScene():m_isLoadFinish(false),m_isInterTouch(false),m_isTouchShop(false),m_armature(nullptr),m_iIndexForShow(0), m_bTouchLock(false){}
// 	virtual ~CMainScene();
