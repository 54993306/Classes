...
class LoginScene: public CScene,public MessageHandler,public CCTargetedTouchDelegate, public CJniListener, public DownloadPackageDelegate
{
public:
	LoginScene();
	~LoginScene();
...
private:
	...
	void onFacebookLogin(CCObject* obj);
